...
<%
    //Obtenemos el registro de producto del atributo enviado desde el controlador
...
<html>
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <form action="http://localhost:8080/marte/admin/productos/editar/<%=prod.getId() %>" method="post" autocomplete="off">
