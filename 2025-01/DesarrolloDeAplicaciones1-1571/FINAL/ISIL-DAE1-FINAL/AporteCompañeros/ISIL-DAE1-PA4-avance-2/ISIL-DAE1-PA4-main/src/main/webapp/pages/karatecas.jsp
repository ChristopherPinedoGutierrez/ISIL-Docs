...
<%! 
    public String obtenerNombreAcademia(ArrayList<Academia> academias, int idLiga) {
        if (academias != null) {
        ...
        <form action="<%=request.getContextPath()%>/karateca" method="post" class="card p-4 shadow rounded-4 bg-white border-0">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="txtEdad" name="edad" required>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="txtPeso" class="form-label fw-semibold">Peso (kg)</label>
                    <input type="text" class="form-control" id="txtPeso" name="peso" required>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="txtSexo" class="form-label fw-semibold">Sexo (F o M)</label>
                    <input type="text" class="form-control text-uppercase" id="txtSexo" name="sexo" maxlength="1" required>
                </div>
                ...
                <% if (karateca != null && !karateca.isEmpty()) {
                    for (Karateca a : karateca) { %>
                        <tr>
                            ...
                            <td><%= obtenerNombreAcademia(academias, a.getIdLiga()) %></td>
                        </tr>
                <% } } else { %>
                    <tr>
